...
const TrainerSidebar = ({ activeSection, setActiveSection, collapsed, setCollapsed, mobileOpen, setMobileOpen }) => {
  ...
  const menuItems = [
    ...
    { id: 'strategies', icon: Lightbulb, label: t('sidebar.strategies') },
  ];
          ...
          <div className={`p-4 border-b ${collapsed ? 'flex justify-center' : ''}`}>
            {!collapsed && (
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-sm">Espace Formateur</span>
              </div>
            )}
            {collapsed && (
              <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center">
