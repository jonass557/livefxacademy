...
/**
 * @swagger
 * /api/backtests/candles:
 *   get:
 *     summary: Bougies récentes d'un marché (graphique en direct)
 *     tags: [Backtests]
 */
// NB: déclarée avant '/:id' pour ne pas être interprétée comme un id.
router.get('/candles', backtestController.getMarketCandles);
